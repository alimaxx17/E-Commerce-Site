...
$page_title = "Register to Sticker Tongue";
...
if($_POST){
    ...
    if($user->emailExists()){
        echo "<div class='alert alert-danger'>";
            echo "The email you want to register is already registered. Please try again.";
        echo "</div>";
    } else {
      ...
      if($user->create()){
        ...
        echo "Successfully registered.Please login</a>.";
        echo "</div>";
